...
plot(1:length(Prueba$PERIODO), Prueba$EXTRA, 
     col="red", type="l", 
     main= "Gráfico Predicción Con Regresion Lineal Ventas EXTRAS",
     xlab = "Periodo",
     ylab= " Galones EXTRA")
...
plot(1:length(Prueba$PERIODO), Prueba$EXTRA, 
     col="red", type="l", 
     main= "Gráfico Predicción Con SVM Kernel Lineal Ventas EXTRAS",
     xlab = "Periodo",
     ylab= " Galones EXTRA")
...
plot(1:length(Prueba$PERIODO), Prueba$EXTRA, 
     col="red", type="l", 
     main= "Gráfico Predicción Con SVM Kernel Polinomico Ventas EXTRAS",
     xlab = "Periodo",
     ylab= " Galones EXTRA")
...
plot(1:length(Prueba$PERIODO), Prueba$EXTRA, 
     col="red", type="l", 
     main= "Gráfico Predicción Con SVM Kernel Radial Ventas EXTRAS",
     xlab = "Periodo",
     ylab= " Galones EXTRA")
